...
%>
        ...
        <div class="card-body" align="center">
				...
				<a class="link-3" href="Profile.jsp?_url=InputPoint.jsp&_size=410px">포인트 충전/환전</a>
        </div>
        </div>
            ...
            <div class="row">
            	...
            	<div class="col-2">
            		<div class="btn-group-vertical">
  						<button id=ChangeUserInfo type="button" class="btn btn-secondary" onclick='open_in_frame("NoticeList.jsp?","900px")'>공지사항</button><hr>
  						<button id=ChangeUserPoint type="button" class="btn btn-secondary" onclick='open_in_frame("FreeList.jsp?","900px")'>자유게시판</button>
					</div>
				</div>            	
                ...
                <!-- 우측 광고 배너 -->			
                <div class="col-2">
                	<div id="STATICMENU"><img src="image/DoubleSixAdv2.png" width="100%" height="auto"></img></div>
				</div>
            </div>
        </div>
