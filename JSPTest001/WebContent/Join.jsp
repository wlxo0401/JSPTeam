...
%>
<form action="JoinCheck.jsp" method="post" onsubmit="return Check()">    
  <div id="login" class="Join">
    <div>
    <div>
    	   <h1 class="h1style"align="center">Sign Up</h1>
    </div>
      <div>
       <label >
        ...
        <input type="text" name="_id" placeholder="아이디 입력"class="inputcolor"></input>
      </div>
      <div >
        <label>
        ...
        <input type="password" name="_pw" id="_pw" placeholder="비밀번호 입력"class="inputcolor"></input>
      </div>
      <div>
        <label >
        <svg version="1.1" class="password-icon" x="0px" y="0px"
        ...
        <input type="password" name="_checkpw" id="_checkpw" placeholder="비밀번호 확인"class="inputcolor"></input>
      </div>
      <div>
        <label >
        <svg version="1.1" class="user-icon" x="0px" y="0px"
        ...
        <input type="text" name="_name" placeholder="성명"class="inputcolor"></input>
      </div>
      <div>
        <label >
        <svg version="1.1" class="user-icon" x="0px" y="0px"
        ...
        <input type="text" name="_phone" placeholder="전화번호"class="inputcolor"></input>
      </div>
    </div>
    <div class="call-to-action">
      <button id="JoinButton" type="submit" onclick="Check()">회원가입</button>
    </div>
  </div>      
  </form>
 ...
 <script>
      function Check() {
          var pw1 = document.getElementById("_pw").value;
          var pw2 = document.getElementById("_checkpw").value;
         if (pw1 == pw2) {
            return true;
         } else {
             alert('비밀번호를 확인해주세요.');
