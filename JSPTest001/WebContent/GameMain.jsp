...
%>
        ...
        <div class="card-body" align="center">
				...
				<a class="link-3" href="Profile.jsp?_url=InputProfile.jsp&_size=500px">회원 정보 변경</a>
				<a class="link-3" href="Profile.jsp?_url=InputPoint.jsp&_size=500px">포인트 충전/환전</a>
        </div>
        </div>
        <!-- 홈페이지 본문 -->
        <div class="card-body">
            <div class="row">
	            ...
	            <!-- 좌측 항목 -->
            	<div class="col-2">
            	<div><img src="image/DoubleSixAdv3.png" width="100%" height="auto"></img></div>
				</div>            	
            	
            	<!-- 메인 항목 -->
                <div class="col">
                	<iframe id=mainframe src="CrossGame.jsp" width=100% height="520px" frameborder="0" scrolling="auto"></iframe>
                </div>		
        ...
        <div class="card-footer">
        	<iframe width=100% height=410px frameborder="0" scrolling="no"></iframe>
        </div>
   		</div>
