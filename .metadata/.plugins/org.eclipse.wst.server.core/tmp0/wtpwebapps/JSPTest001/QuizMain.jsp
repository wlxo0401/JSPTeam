...
%>
        ...
        <div class="card-body" align="center">
				...
				<a class="link-3" href="Profile.jsp?_url=InputProfile.jsp&_size=440px">회원 정보 변경</a>
            ...
            <div class="row">
            	...
            	<div class="col-2">
            		<div class="btn-group-vertical">
  						<button id=ChangeUserInfo type="button" class="btn btn-secondary" onclick='open_in_frame("CommonQuizMain.jsp","900px")'>상식퀴즈</button><hr>
  						<button id=ChangeUserPoint type="button" class="btn btn-secondary" onclick='open_in_frame("GameQuizMain.jsp","900px")'>게임퀴즈</button><hr>
  						<button id=ChangeUserPoint type="button" class="btn btn-secondary" onclick='open_in_frame("EntertainmentsQuizMain.jsp","900px")'>연예퀴즈</button>
					</div>
				</div>            	
            	
            	<!-- 메인 항목 -->
                <div class="col">
                	<iframe id=mainframe src=<%=url %> width=100% height=<%=size %> frameborder="0" scrolling="auto"></iframe>
                </div>		
