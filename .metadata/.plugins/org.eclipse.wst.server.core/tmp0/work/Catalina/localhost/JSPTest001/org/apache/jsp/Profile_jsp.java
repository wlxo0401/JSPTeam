 ...
 * Generated at: 2019-12-18 04:36:22 UTC
...
if(size==null)
{
	size = "500px";
      ...
      out.write("  \t\t\t\t\t\t<button id=ChangeUserInfo type=\"button\" class=\"btn btn-secondary\" onclick='open_in_frame(\"InputProfile.jsp\",\"500px\")'>회원 정보 변경</button><hr>\r\n");
      out.write("  \t\t\t\t\t\t<button id=ChangeUserPoint type=\"button\" class=\"btn btn-secondary\" onclick='open_in_frame(\"InputPoint.jsp\",\"500px\")'>포인트 충전/환전</button>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>            \t\r\n");
      out.write("            \t\r\n");
      out.write("            \t<!-- 메인 항목 -->\r\n");
